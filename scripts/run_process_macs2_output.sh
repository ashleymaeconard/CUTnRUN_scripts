...
# Runs MACS2 bdgcmp in /gpfs/main/home/aconard/venv/bin/macs2 for all macs2 callpeak files in .../results/macs2/

# Check to make sure input is correct
if [ $# -ne 2 ]; then
	echo $0: "Usage: ./run_process_macs2_output.sh /PATH/TO/MACS_OUTPUT/FOLDER/ (containing folders of MACS2 callpeak output files, (e.g. only write up to macs2 here: .../results/macs2/clamp_sg_fm/out.sorted.bam_peaks.xls) PROCESSORS \n NOTE: MAKE SURE source ~/venv/bin/activate FOR PROPER PYTHON ENVIRONMENT."
	exit 1
fi
